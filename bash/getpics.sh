...
mkdir -p ~/public_html/pics2 || (echo "Failed to make new pics2 Directory" && exit 1)
...
wget -q -O ~/public_html/pics2/pics.tgz https://zonzorp.net/pics.tgz && unzip -d ~/public_html/pics2 -o -q ~/public_html/pics2/pics.tgz && rm ~/public_html/pics2/pics.tgz
...
test -d ~/public_html/pics2 && cat <<EOF
